...
//for buttonsets
// `extern` so they can be modified by grafting plugin
extern BUTTON_SET* buttonSetTable;
extern UnitStatFuncArrayEntry* unitStatFuncs;
extern u32 orderDatReqScript;
